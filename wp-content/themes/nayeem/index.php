  ...
  <section class="experience_section layout_padding">
    <div class="container">
      <div class="row">
        <div class="col-md-5">
          <div class="img-box">
            <img src="<?php echo get_template_directory_uri();?>/images/experience-img.jpg" alt="">
          </div>
        </div>
        <div class="col-md-7">
          <div class="detail-box">
  ...
  <section class="category_section layout_padding">
    <div class="container">
      ...
      <div class="category_container">
        <div class="box">
          <div class="img-box">
            <img src="<?php echo get_template_directory_uri();?>/images/c1.png" alt="">
          </div>
          <div class="detail-box">
            <h5>
              Design & Arts
        ...
        <div class="box">
          <div class="img-box">
            <img src="<?php echo get_template_directory_uri();?>/images/c2.png" alt="">
          </div>
          <div class="detail-box">
            <h5>
              Web Development
        ...
        <div class="box">
          <div class="img-box">
            <img src="<?php echo get_template_directory_uri();?>/images/c3.png" alt="">
          </div>
          <div class="detail-box">
            <h5>
              SEO Markting
        ...
        <div class="box">
          <div class="img-box">
            <img src="<?php echo get_template_directory_uri();?>/images/c4.png" alt="">
          </div>
          <div class="detail-box">
            <h5>
              Video Edting
        ...
        <div class="box">
          <div class="img-box">
            <img src="<?php echo get_template_directory_uri();?>/images/c5.png" alt="">
          </div>
          <div class="detail-box">
            <h5>
              Logo Design
        ...
        <div class="box">
          <div class="img-box">
            <img src="<?php echo get_template_directory_uri();?>/images/c6.png" alt="">
          </div>
          <div class="detail-box">
            <h5>
              Game Design
        ...
        <div class="row">
            ...
            <div class="detail-box">
              ...
              <div class="tab_container">
                ...
                <div class="t-link-box collapsed" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                  <div class="img-box">
                    <img src="<?php echo get_template_directory_uri();?>/images/f2.png" alt="">
                  </div>
                  <div class="detail-box">
                    <h5>
                      2 Million
                ...
                <div class="t-link-box collapsed" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                  <div class="img-box">
                    <img src="<?php echo get_template_directory_uri();?>/images/f3.png" alt="">
                  </div>
                  <div class="detail-box">
                    <h5>
                      700,000
                ...
                <div class="t-link-box collapsed" data-toggle="collapse" data-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                  <div class="img-box">
                    <img src="<?php echo get_template_directory_uri();?>/images/f4.png" alt="">
                  </div>
                  <div class="detail-box">
                    <h5>
                      98%
          ...
          <div class="col-md-6">
            <div class="collapse show" id="collapseOne" aria-labelledby="headingOne" data-parent="#accordion">
              <div class="img-box">
                <img src="<?php echo get_template_directory_uri();?>/images/freelance-img.jpg" alt="">
              </div>
            </div>
